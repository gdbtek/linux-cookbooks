...
export GO_CD_SERVER_DOWNLOAD_URL='https://download.go.cd/gocd/go-server-15.3.1-2777.zip'
export GO_CD_AGENT_DOWNLOAD_URL='https://download.go.cd/gocd/go-agent-15.3.1-2777.zip'
