...
export GO_CD_SERVER_DOWNLOAD_URL='https://download.go.cd/gocd/go-server-16.1.0-2855.zip'
export GO_CD_AGENT_DOWNLOAD_URL='https://download.go.cd/gocd/go-agent-16.1.0-2855.zip'
