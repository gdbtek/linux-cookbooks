...
export GO_SERVER_SERVER_DOWNLOAD_URL='http://download.go.cd/gocd/go-server-15.2.0-2248.zip'
export GO_SERVER_AGENT_DOWNLOAD_URL='http://download.go.cd/gocd/go-agent-15.2.0-2248.zip'
